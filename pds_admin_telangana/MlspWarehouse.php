...
<style>
    ...
    /* Optional: Font size for table header */
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">MLSP Warehouse</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                                    <h3 class="panel-title">MLSP Warehouse</h3>
                                </div>
								<a href="BulkMlspWarehouseStatusChange.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">District-Wise Status Change</button></a>
								<a href="BulkMlspWarehouseDataEdit.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-warning">Bulk Data Edit</button></a>
								...
								<span style="float:right;margin-top:10px;margin-right:13px"><button type="button" id="loadMlspDataBtn" onclick="loadMlspWarehouseData()" class="btn btn-primary">Load Data</button></span>
								...
								<div id="loadMlspMessage" style="clear:both; margin:55px 13px 0 13px;"></div>
                                ...
                                <div class="panel-body">
                                 <div class="table-responsive">
                                    <table id="export_table" class="table datatable">
										...
										$query = "SELECT * FROM mlsp_warehouse WHERE 1 ORDER BY district";
    ...
    <!-- START SCRIPTS -->
		...
		function edit_entry(temp_id){
			post({uid: temp_id} ,"MlspWarehouseEdit.php");
		}
		...
		function VerifyAndDelete(){
			...
			post({uid: temp_id,username:username,password:password} ,"api/MlspWarehouseDelete.php");
		}
		...
		function showLoadMessage(message, type){
			var container = document.getElementById('loadMlspMessage');
			if(!container){
				return;
			}
		...
		function loadMlspWarehouseData(){
			var btn = document.getElementById('loadMlspDataBtn');
			btn.disabled = true;
			btn.textContent = 'Loading...';
			$.ajax({
				type: "POST",
				url: "api/LoadMlspWarehouseData.php",
				cache: false,
				dataType: "text",
