...
if(isset($_POST["uid"])){
	$uniqueid = $_POST["uid"];
	$query = "SELECT * FROM mlsp_warehouse WHERE uniqueid='$uniqueid'";
	...
	if($numrows!=0){
		...
		header("Location:MlspWarehouse.php");
	}
}
else{
	header("Location:MlspWarehouse.php");
		...
		for (var i = 0; i < obj.options.length; i++) {
			if (obj.options[i].text== valueToSet) {
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">MLSP Warehouse Edit</li>
                </ul>
                <!-- END BREADCRUMB -->
                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/MlspWarehouseEdit.php" method="POST" class="form-horizontal" enctype = "multipart/form-data">
                            <div class="panel panel-default">
                               <div class="panel-body">
                                    <p>Fill this form to edit MLSP warehouse.</p>
                                </div>
