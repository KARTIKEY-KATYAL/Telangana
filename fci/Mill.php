...
<script src="js/Encryption.js"></script>
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                                    <h3 class="panel-title">Mill</h3>
                                </div>
								<a href="BulkMillStatusChange.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">District-Wise Status Change</button></a>
								<a href="BulkMillDataEdit.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-warning">Bulk Data Edit</button></a>
								<a href="BulkMillData.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">Bulk Data Add</button></a>
								...
								<a href="MillAdd.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-success">Add New</button></a>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
												...
												<th style="font-size:16px">Name of Mill</th>
												<th style="font-size:16px">Mill ID</th>
    ...
    <!-- START SCRIPTS -->
		...
		function edit_entry(temp_id){
			post({uid: temp_id} ,"MillEdit.php");
		}
		
		function change_status(temp_id){
			post({uid: temp_id} ,"api/MillStatus.php");
		}
		...
		function VerifyAndDelete(){
			...
			post({uid: temp_id,username:username,password:encrypted} ,"api/MillDelete.php");
		}
