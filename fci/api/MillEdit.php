...
if(!isStringNumber($_POST["demand"])){
	echo "Error : Check Capacity of mill Value";
	exit();
}
if(!isStringNumber($_POST["demand_rice"])){
	echo "Error : Check Processing capacity of mill Value";
	exit();
}
...
writeLog("User ->" ." Mill Data Edit->". $_SESSION['user'] . "| Requested JSON -> " . json_encode($filteredPost));
